      ...
      body: page.when(
        ...
        data: (data) {
          if (data.items.isEmpty) {
            return const Center(child: Text('هنوز تراکنشی ثبت نشده.'));
          }
              ...
              child: ListView.separated(
                ...
                itemBuilder: (context, i) {
                  ...
                  return ListTile(
                    ...
                    trailing: Text(
                      '${income ? '+' : '−'}${formatTomanFromRial(t.amount, fa: true)}',
                      style: TextStyle(fontWeight: FontWeight.w600, color: income ? Colors.green : Colors.red),
                    ),
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: wallets.isEmpty || categories.isEmpty
            ? () => ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(content: Text('ابتدا یک کیف پول و دسته‌بندی بسازید.')),
              )
        ...
        builder: (context, setState) {
          ...
          return AlertDialog(
              ...
              child: Column(
                ...
                children: [
                  SegmentedButton<TransactionType>(
                    segments: const [
                      ButtonSegment(value: TransactionType.EXPENSE, label: Text('هزینه')),
                      ButtonSegment(value: TransactionType.INCOME, label: Text('درآمد')),
                    ],
                    selected: {type},
                  ...
                  if (filtered.isEmpty)
                    ...
                    DropdownButtonFormField<String>(
                      ...
                      items: [for (final c in filtered) DropdownMenuItem(value: c.id, child: Text(c.name))],
            ...
            actions: [
              TextButton(onPressed: () => Navigator.pop(context, false), child: const Text('انصراف')),
              FilledButton(
                onPressed: categoryId == null ? null : () => Navigator.pop(context, true),
