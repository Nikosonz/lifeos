...
function DropdownMenuCheckboxItem({
  ...
  // `checked` is deliberately left inside ...props (not destructured out and
  // re-passed) — under this project's exactOptionalPropertyTypes: true, an
  // explicit `checked={checked}` widens the JSX attribute's type to include
  // `| undefined` even when the caller never passed it, which Radix's own
  // prop type rejects. Spreading it through unchanged preserves "absent
  // means absent" instead of "present with value undefined".
  return (
