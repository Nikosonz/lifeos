import { TaskCreateInput, TaskListQuery, TaskListResponse, TaskResponse } from "@lifeos/contracts";
import { taskService } from "@lifeos/core";
import { defineRoute } from "@/lib/route-handler";
import { toResponse } from "./to-response";

export const POST = defineRoute(
  { body: TaskCreateInput, response: TaskResponse },
...
export const GET = defineRoute(
  { query: TaskListQuery, response: TaskListResponse },
  async ({ userId, query }) => {
