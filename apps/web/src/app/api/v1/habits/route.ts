import { HabitCreateInput, HabitListResponse, HabitResponse } from "@lifeos/contracts";
import { habitService } from "@lifeos/core";
import { defineRoute } from "@/lib/route-handler";
import { toResponse } from "./to-response";

export const POST = defineRoute(
  { body: HabitCreateInput, response: HabitResponse },
...
export const GET = defineRoute({ response: HabitListResponse }, async ({ userId }) => {
